...
const features = [
  {
    icon: "/icons/icon-hero-1.svg", // Replace with your 'camera-macro.svg'
  ...
  {
    icon: "/icons/icon-hero-2.svg", // Replace with 'graduationcap.svg'
  ...
  {
    icon: "/icons/icon-hero-3.svg", // Replace with 'fork-knife.svg'
  ...
  {
    icon: "/icons/icon-hero-4.svg", // Replace with 'backpack.svg'
  ...
  {
    icon: "/icons/icon-hero-5.svg", // Replace with 'dumbbell.svg'
  ...
  {
    icon: "/icons/icon-hero-6.svg", // Replace with 'wallet-pass.svg'
...
export default function Features() {
  return (
    <section className="bg-[#F6FBE9] py-16 md:py-20 lg:py-24">
            ...
            return (
              ...
              >
                <div className="flex items-center gap-6">
                  <div className="w-12 h-12 bg-linear-to-br from-[#CBEA7B] to-[#B8D96D] rounded-xl flex items-center justify-center mb-4">
                    <Image
                      src={feature.icon}
                      alt={feature.title}
                      width={28}
                      height={28}
                      className="text-[#234338]"
                    />
                    {/* <Icon className="w-7 h-7 text-[#234338]" /> */}
                  </div>
